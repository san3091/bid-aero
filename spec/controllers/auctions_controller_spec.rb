  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created auction as @auction" do
        ...
        expect(assigns(:auction)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved auction as @auction" do
        post :create, {:auction => invalid_attributes}, valid_session
        expect(assigns(:auction)).to be_a_new(Auction)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested auction" do
        auction = Auction.create! valid_attributes
        put :update, {:id => auction.to_param, :auction => new_attributes}, valid_session
        auction.reload
    ...
    context "with invalid params" do
      it "assigns the auction as @auction" do
        auction = Auction.create! valid_attributes
        put :update, {:id => auction.to_param, :auction => invalid_attributes}, valid_session
        expect(assigns(:auction)).to eq(auction)
      end
